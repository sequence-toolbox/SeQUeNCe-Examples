...
if __name__ == "__main__":
    ...
    NUM_CLIENTS= 3
    network_config = str(Path(__file__).resolve().parent / "topologies" / f"qlan_topology_{NUM_CLIENTS}.json")
    ...
    log_filename = str(Path(__file__).resolve().with_name("qlan_app.log"))
